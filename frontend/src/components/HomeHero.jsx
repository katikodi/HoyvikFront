...
export default function HomeHero() {
    return (
        <section className="flex h-dvh flex-col bg-[url(/images/real-photos/aerial-photo.webp)] bg-cover bg-no-repeat bg-center">
            <header className="pt-52 pl-4 md:pl-20 text-[#9BB678] text-shadow-[0_4px_4px_rgb(0_0_0/0.25)]">
                <h1 className="font-serif text-2xl/normal md:text-3xl/normal font-normal not-italic">
