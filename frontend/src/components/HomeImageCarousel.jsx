...
export default function HomeImageCarousel() {
    const cards = [
        {
            title: "Salong",
            description: "Ett rom",
            image: "/images/real-photos/salong.webp"
        },
        {
            title: "Kjøkken",
            description: "Enda ett rom",
            image: "/images/real-photos/kjokken.webp"
        },
        {
            title: "Kjøkken",
            description: "Rom",
            image: "/images/real-photos/kjokken2.webp"
        },
        {
            title: "Kjøkken",
            description: "Rom",
            image: "/images/real-photos/kjokken3.webp"
        },
        {
            title: "Bad",
            description: "Rom",
            image: "/images/real-photos/bad.webp"
        },
        {
            title: "Bad",
            description: "Rom",
            image: "/images/real-photos/bad2.webp"
        }
    ];

    return (
        <div className="w-full bg-secondary px-0 md:px-4 py-4">
            <div className="w-full flex justify-center items-center overflow-x-clip bg-secondary">
                <ParallaxCarousel slides={cards} />
            </div>
        </div>
    );
    ...
    //                     <CardDescription className="text-brown col-span-2">
    //                       {card.description}
    //                     </CardDescription>
    //                   </CardHeader>
