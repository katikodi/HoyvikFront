        ...
        <Popover {...props}>
            <PopoverTrigger asChild>
                <Button
                    variant="outline"
                    data-empty={!value}
                    className="justify-start text-left font-normal data-[empty=true]:text-muted-foreground data-[empty=false]:bg-muted rounded-none h-full w-fit bg-transparent border-2 border-solid border-[#2A3430]"
                >
                    <CalendarIcon className="size-8" />
                    {value ? format(new Date(value).setHours(12), "PPPP GG BBBB", { locale: nn }) : <span>Pick a date</span>}
                </Button>
            </PopoverTrigger>
